...
<body>
    ...
    <div class="title">
        <h2>LAPORAN BON CUTI</h2>
        <p>Diajukan antara {{ \Illuminate\Support\Carbon::parse($filters['start_date'])->translatedFormat('d F Y') }}
